...
export async function GET(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
    try {
        ...
        const template = await AssessmentTemplateService.getAssessmentTemplate(id);
...
export async function DELETE(
    ...
    try {
        const { id } = await params;
        const result = await AssessmentTemplateService.deleteAssessmentTemplate(id);
...
export async function PUT(request: NextRequest, { params }: { params: Promise<{ id: string }> }) {
    try {
        ...
        const updatedTemplate = await AssessmentTemplateService.updateAssessmentTemplate(parsed);
