    ...
    return (
        <div className="bg-s-lightgrey bg-opacity-50 fixed inset-0 flex justify-center items-center">
            <div className="rounded-lg bg-white p-6 border border-[#E5E5E5] w-140 h-78 flex flex-col items-center justify-center">
                <h2 className="mt-4 mb-2 text-xl text-black text-center font-bold">Welcome!</h2>
                ...
                <div>
                    ...
                    <button className="bg-white text-s-purple mt-1 mb-2 flex w-106 justify-center rounded-lg py-2">
                        Join Organization
                    </button>
                </div>
            </div>
