...
export function CreateOrganizationModal({ fileInputRef, handleFileChange, handleProfileImageClick, preview, setOrganizationName, setCreateOrJoinOrganization, submitOrganization, setCreateOrganization }: CreateOrganizationModalParams) {
    return (
        <Dialog open={true}>
            ...
            <DialogContent className="sm:max-w-[425px]" showCloseButton={false}>
                <div className='flex flex-col justify-center'>
                    ...
                    <div className='flex mt-4 mb-2 content-center justify-center w-full'>
                        <div
                            className="inline-flex h-[292px] w-[544px] flex-col items-start justify-center gap-[10px] px-[36px] py-[60px] rounded-2xl bg-white shadow-md"
                    ...
                    <div className='justify-between flex mt-4 items-center'>
                        <p className='text-sarge-primary-700 hover:cursor-pointer' onClick={() => { setCreateOrJoinOrganization(true); setCreateOrganization(false) }}>Back</p>
                        <Button variant='primary' size='default' className='w-[125px]' onClick={() => submitOrganization()}>Continue</Button>
                    </div>
                </div>
            </DialogContent>
        </Dialog>
