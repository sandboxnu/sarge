    ...
    "inline-flex shrink-0 items-center justify-center rounded-lg text-sm font-medium whitespace-nowrap transition-all outline-none hover:cursor-pointer disabled:pointer-events-none [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:h-[20px] [&_svg:not([class*='size-'])]:w-[20px]",
    {
        variants: {
            variant: {
                ...
                destructive:
                    'bg-sarge-error-500 hover:bg-sarge-error-700 text-sarge-gray-50 [&_svg]:text-sarge-gray-50 disabled:bg-sarge-error-200 gap-[10px] px-1 py-2 transition-colors duration-200 disabled:cursor-not-allowed disabled:opacity-100',
            },
        },
        defaultVariants: {
            variant: 'primary',
