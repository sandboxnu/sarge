...
export function Sidebar() {
    ...
    return (
        <ShadSidebar
            className={cn(
                '!top-[var(--navbar-height)] !h-[calc(100vh-var(--navbar-height))] border-r-4 border-sarge-primary-100 bg-sarge-primary-100',
        ...
        >
            <SidebarHeader className="group-data-[collapsible=icon]:px-1 group-data-[collapsible=icon]:pb-2">
                <div className="flex items-center justify-between gap-3 group-data-[collapsible=icon]:w-full group-data-[collapsible=icon]:justify-center">
                    ...
                    <ChevronDown className="h-3 w-3 text-sarge-gray-600 group-data-[collapsible=icon]:hidden" />
                </div>
            </SidebarHeader>
            <SidebarContent>
                        ...
                        <SidebarMenu className="space-y-1">
                            {sidebarMenuItems.map((item) => (
                                <SidebarMenuItem key={item.title}>
                                    <SidebarMenuButton
                                        tooltip={item.title}
                                        className="!important group-data-[collapsible=icon]:!mx-auto group-data-[collapsible=icon]:!h-8 group-data-[collapsible=icon]:!w-8 group-data-[collapsible=icon]:p-0 hover:cursor-pointer hover:!bg-sarge-primary-100 focus:!bg-sarge-primary-200 [&:hover]:!bg-sarge-primary-100"
