...
export function Sidebar() {
    ...
    return (
        <ShadSidebar
            className={cn(
                'border-r-4 border-sarge-primary-100 bg-sarge-primary-100',
            ...
            <SidebarHeader className="group group-data-[collapsible=icon]:px-1 group-data-[collapsible=icon]:pb-2">
                ...
                <div className="flex items-center justify-between gap-3 group-data-[collapsible=icon]:w-full group-data-[collapsible=icon]:justify-center">
                    <div className="flex flex-1 items-center gap-2">
                        ...
                        <ChevronDown className="ml-auto h-3 w-3 text-sarge-gray-600 group-data-[collapsible=icon]:hidden" />
                    </div>

                    <SidebarTrigger className="bg-sarge-gray-100 hidden items-center rounded-lg transition-all duration-200 group-hover:flex group-data-[collapsible=icon]:hidden hover:bg-sarge-primary-100" />
                </div>
            </SidebarHeader>
            <SidebarContent>
                        ...
                        <SidebarMenu className="space-y-1">
                            {sidebarMenuItems.map((item) => (
                                <SidebarMenuItem key={item.title}>
                                    <SidebarMenuButton
                                        tooltip={item.title}
                                        className="gap-x-3 p-2.5 transition-colors duration-600 ease-out group-data-[collapsible=icon]:!mx-auto group-data-[collapsible=icon]:!h-8 group-data-[collapsible=icon]:!w-8 group-data-[collapsible=icon]:p-0 hover:cursor-pointer hover:bg-sarge-primary-100 focus:bg-sarge-primary-200"
                                        onClick={() => router.push(item.url)}
                                    >
                                        <item.icon className="h-4 w-4 text-sarge-gray-600" />
                                        <span className="text-xs font-medium text-sarge-gray-800 group-data-[collapsible=icon]:hidden">
                                            {item.title}
                                        </span>
                                    </SidebarMenuButton>
                                </SidebarMenuItem>
                ...
                <SidebarMenu>
                    <SidebarMenuItem>
                        <SidebarMenuButton
                            ...
                            className="p-2.5 transition-colors duration-600 ease-out group-data-[collapsible=icon]:!mx-auto group-data-[collapsible=icon]:!h-8 group-data-[collapsible=icon]:!w-8 group-data-[collapsible=icon]:p-0 hover:cursor-pointer hover:!bg-sarge-primary-100 focus:!bg-sarge-primary-200"
                        >
                            <Settings className="!h-4 !w-4 text-sarge-gray-600" />
                            <span className="text-xs font-medium text-sarge-gray-800 group-data-[collapsible=icon]:hidden">
                    ...
                    <SidebarMenuItem>
                        ...
                        >
                            {auth.user?.image ? (
                                ...
                                <div className="flex h-4 w-4 items-center justify-center rounded-full bg-sarge-gray-200 text-[10px] font-medium text-sarge-gray-600 group-data-[collapsible=icon]:mx-auto">
                                    {auth.user?.name[0]}
                                </div>
                            )}
                            <span className="text-xs font-medium text-sarge-gray-800 group-data-[collapsible=icon]:hidden">
